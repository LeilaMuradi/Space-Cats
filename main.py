...
haert = pg.image.load('сердце.png').convert_alpha()
haert = pg.transform.scale(haert, (30, 30))
haert_cont = 3
...
lasers_sound = pg.mixer.Sound('звук лазера.wav')
...
while is_running:
    ...
    if mode == "meteorites":
        ...
        for i in range(haert_cont):
            screen.blit(haert, (i * 30, 0))
